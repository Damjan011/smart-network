...
const InfoWindowContent = () => {
  ...
  const wrapperSetAcknowledge = useCallback(val => {
    setAcknowledge(val);
  }, [setAcknowledge]);
  return (
    <div className={acknowledge ? 'ajmoo' : ''}>
      {!acknowledge &&
        <div className="info-window-main">
          ...
          <div className="ui-info-window-body">
            ...
            <div className="ui-info-window-acknowledge-row">
              <div>
                <a className="ui-blue-item" href="# " onClick={() => setAcknowledge(true)}>
      ...
      }
      {
        ...
        <div>   
          <InfoWindowAcknowledge 
            ...
            parentStateSetter={wrapperSetAcknowledge}/>
        </div>
      }
    </div>
  );
