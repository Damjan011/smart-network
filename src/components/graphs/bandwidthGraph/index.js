    ...
    <div id="bandwidth-usage" className="ui-box" style={{ padding: '20px', overflow: 'visible' }}>
      ...
      <ResponsiveContainer width='100%' height={180}>
        <LineChart
          ...
          <XAxis allowDataOverflow={true} tick={{ dx: 20 }} interval={2} tickLine={false} dataKey='name' />
          ...
          <Line dataKey="uv" stroke="#6EE294" strokeWidth="4" dot={false} activeDot={false} />
          <Line dataKey="pv" stroke="#5F72FF" strokeWidth="4" dot={false} activeDot={false} />
        </LineChart>
      </ResponsiveContainer>
    </div>
  );
